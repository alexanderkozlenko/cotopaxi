...
{
    public static readonly Argument<string> PackageArgument = new("package", "The path to a package or packages to deploy to the Azure Cosmos DB account");
    ...
    public AppDeployCommand()
        : base("deploy", "Deploys the package or packages to the Azure Cosmos DB account")
    {
    }
}

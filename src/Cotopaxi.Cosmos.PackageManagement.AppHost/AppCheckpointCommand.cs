...
internal sealed class AppCheckpointCommand : Command
{
    ...
    public static readonly Argument<string> RollbackPackageArgument = new("rollback-package", "The path to a package that reverts operations from the source package or packages");

...
{
    public readonly Argument<string> PackageArgument = new("package", "The path to the database package or packages to deploy to the Azure Cosmos DB account");
    ...
    public readonly Option<string> ProfileOption = new("--profile", "The path to the deployment profile or profiles that specify documents eligible for updates");
    public readonly Option<bool> DryRunOption = new("--dry-run", "Show which operations would be executed instead of actually executing them");

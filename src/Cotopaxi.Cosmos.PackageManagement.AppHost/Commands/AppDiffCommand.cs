...
internal sealed class AppDiffCommand : Command
{
    ...
    public static readonly Option<string> ProfileOption = new("--profile", "The path to the deployment profile to generate based on new and modified documents");
    public static readonly Option<bool> ExitCodeOption = new("--exit-code", "Instruct the program to exit with 1 if there were differences and 0 otherwise");
